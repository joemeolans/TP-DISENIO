...
namespace TP_DISEÑO.DAO
{
    ...
    {
        public competencia GetCompetencia(int id, CapitalHumano3Entities context)
        {
            competencia competencia = context.competencia.Find(id);
            return competencia;
        }
        public competencia GetCompetenciaByNombre(string nombre, CapitalHumano3Entities context)
        {
        ...
        public List<string> GetAllCompetencias(CapitalHumano3Entities context)
        {
